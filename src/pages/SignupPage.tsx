      ...
      <main className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-solar-dark-background py-12 px-4 sm:px-6 lg:px-8 pt-24 md:pt-28">
        <Card className="w-full max-w-md shadow-xl">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl font-bold text-primary">Tạo Tài Khoản</CardTitle>
            <CardDescription>Tham gia cùng chúng tôi ngay hôm nay!</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <form onSubmit={handleSignup} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="email-signup">Địa chỉ Email</Label>
                <Input
                  id="email-signup"
                  type="email"
              ...
              <div className="space-y-2">
                <Label htmlFor="confirmPassword-signup">Xác nhận Mật khẩu</Label>
                <Input
