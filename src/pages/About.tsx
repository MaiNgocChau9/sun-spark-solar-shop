  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="pt-32 pb-16 bg-gradient-to-r from-solar-50 to-solar-200 dark:from-gray-800 dark:to-gray-900">
        ...
        <section className="py-16">
          <div className="container">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-6 text-foreground dark:text-white">Câu chuyện của chúng tôi</h2>
              ...
              <div className="relative">
                ...
                />
                <div className="absolute -bottom-6 -right-6 bg-card dark:bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <section className="py-16 bg-muted/30 dark:bg-gray-900">
          <div className="container">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 className="text-3xl font-bold mb-6 text-foreground dark:text-white">Tầm nhìn & Sứ mệnh</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-card dark:bg-gray-800 rounded-xl p-8 shadow-sm hover:shadow-md transition-shadow">
                <div className="bg-primary/10 text-primary rounded-full w-16 h-16 flex items-center justify-center mb-6">
                  <Sun className="h-8 w-8" />
                </div>
                <h3 className="text-2xl font-bold mb-4 text-foreground dark:text-white">Tầm nhìn</h3>
                <p className="text-muted-foreground dark:text-gray-300">
              ...
              <div className="bg-card dark:bg-gray-800 rounded-xl p-8 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-2xl font-bold mb-4 text-foreground dark:text-white">Sứ mệnh</h3>
                <p className="text-muted-foreground dark:text-gray-300">
        ...
        <section className="py-16">
          <div className="container">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 className="text-3xl font-bold mb-6 text-foreground dark:text-white">Giá trị cốt lõi</h2>
              <p className="text-lg text-muted-foreground dark:text-gray-300">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-card dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-primary/10 text-primary rounded-full mb-4">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-8 w-8">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <h3 className="text-xl font-bold mb-2 text-foreground dark:text-white">Chất lượng</h3>
                <p className="text-muted-foreground dark:text-gray-300">
              ...
              <div className="bg-card dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-bold mb-2 text-foreground dark:text-white">Đổi mới</h3>
                <p className="text-muted-foreground dark:text-gray-300">
              ...
              <div className="bg-card dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-bold mb-2 text-foreground dark:text-white">Khách hàng</h3>
                <p className="text-muted-foreground dark:text-gray-300">
              ...
              <div className="bg-card dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-bold mb-2 text-foreground dark:text-white">Bền vững</h3>
                <p className="text-muted-foreground dark:text-gray-300">
        ...
        <section className="py-16 bg-muted/30 dark:bg-gray-900">
          <div className="container">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 text-foreground dark:text-white">Đội ngũ của chúng tôi</h2>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-card dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <img 
                ...
                <div className="p-4 text-center">
                  <h3 className="font-bold text-lg text-foreground dark:text-white">Trần Minh Quân</h3>
              ...
              <div className="bg-card dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                ...
                />
                <div className="p-4 text-center">
                  <h3 className="font-bold text-lg text-foreground dark:text-white">Nguyễn Thị Hương</h3>
              ...
              <div className="bg-card dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                ...
                />
                <div className="p-4 text-center">
                  <h3 className="font-bold text-lg text-foreground dark:text-white">Lê Đức Thành</h3>
              ...
              <div className="bg-card dark:bg-gray-800 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                ...
                />
                <div className="p-4 text-center">
                  <h3 className="font-bold text-lg text-foreground dark:text-white">Phạm Thị Mai</h3>
        ...
        <section className="py-16">
          <div className="container">
            <div className="max-w-3xl mx-auto text-center mb-12">
              <h2 className="text-3xl font-bold mb-6 text-foreground dark:text-white">Thành tựu của chúng tôi</h2>
              <p className="text-lg text-muted-foreground dark:text-gray-300 mb-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mb-12">
              <div className="bg-card dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-muted-foreground dark:text-gray-300">Khách hàng hài lòng</p>
              </div>
              
              <div className="bg-card dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                <div className="text-4xl font-bold text-primary mb-2">100+</div>
                <p className="text-muted-foreground dark:text-gray-300">Dự án lớn</p>
              </div>
              
              <div className="bg-card dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                <div className="text-4xl font-bold text-primary mb-2">50 MW</div>
                <p className="text-muted-foreground dark:text-gray-300">Công suất lắp đặt</p>
              </div>
              
              <div className="bg-card dark:bg-gray-800 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow">
                <div className="text-4xl font-bold text-primary mb-2">20+</div>
                <p className="text-muted-foreground dark:text-gray-300">Giải thưởng</p>
              </div>
            </div>
            
            <div className="grid sm:grid-cols-3 gap-6">
              <div className="bg-card dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <div className="mb-4">
                  <img 
                ...
                <h3 className="text-center font-bold mb-2 text-foreground dark:text-white">Top Solar Solution Provider 2024</h3>
              ...
              <div className="bg-card dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-center font-bold mb-2 text-foreground dark:text-white">Green Energy Innovation 2023</h3>
                <p className="text-center text-sm text-muted-foreground dark:text-gray-300">
              ...
              <div className="bg-card dark:bg-gray-800 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="text-center font-bold mb-2 text-foreground dark:text-white">Best Customer Service 2023</h3>
                <p className="text-center text-sm text-muted-foreground dark:text-gray-300">
